...
<form id="myForm" method="POST" class="row m-3 p-0 needs-validation" novalidate>
    ...
    <div class="col-md-12">Unsere Gläubiger ID im SEPA Lastschriftverfahren: <strong>DE04 ZZZ0 0000 4535 66</strong></div>
...
<div class="row p-3">
    <button onclick="submitForm();" class="btn btn-primary mt-3">weiter zu Antragsdaten prüfen</button>
</div>